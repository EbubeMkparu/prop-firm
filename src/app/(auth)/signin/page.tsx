        ...
        <div className="relative">
          ...
          <div className="relative bg-gradient-to-b from-gray-900/90 to-black/90 backdrop-blur-xl rounded-3xl p-8 border border-gray-800/50 shadow-2xl">
            ...
            <div className="flex justify-center">
              <button className="flex items-center justify-center gap-2 py-3 px-8 bg-gray-900/50 border border-gray-700/50 rounded-xl hover:bg-gray-800/50 hover:border-gray-600 transition-all duration-300 group">
